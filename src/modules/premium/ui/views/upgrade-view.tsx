        ...
        <div className="flex-1 py-4 px-4 md:px-8 flex flex-col gap-y-10">
            <div className="mt-4 flex-1 flex flex-col gap-y-10 items-center">
                <h5 className="font-medium text-2xl md:text-3xl">
                    You are on the {" "}
                    <span className="text-primary font-semibold">{ currentSubscription?.name ?? "Free"}</span>{" "}
                    Plan
                </h5>
...
export const UpgradeViewError = () => (
    <ErrorState title="Error" description="Something went wrong while fetching the upgrade page" />
);

export const UpgradeViewLoading = () => (
    <LoadingState title="Loading" description="Please wait while we load this page" />
)