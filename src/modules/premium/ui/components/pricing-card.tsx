...
const pricingCardVariants = cva("rounded-lg py-4 py-6 w-full", {
    variants: {
        variant: {
            default: "bg-white text-black",
            highlighted: "bg-linear-to-br from-[#093C5E] to-[#051B2F] text-white"
        }
    },
    defaultVariants: {
        variant: "default"
...
export const PricingCard = ({ variant, price, badge, features, title, description, priceSuffix, className, buttonText, onClick }:Props) => {
    return (
        <div className={cn(pricingCardVariants({ variant }), className, "border px-4 ")}>
